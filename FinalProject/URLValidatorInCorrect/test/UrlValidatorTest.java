...
public class UrlValidatorTest extends TestCase {
   ...
   // public static void resultPairTestValidator() {
   //    String[] schemes = { "http", "https" };
   //    UrlValidator urlValidator = new UrlValidator(schemes);
   //    // assertTrue(urlVal.isValid("http://www.google.com"));
   //    ResultPair testPairA = new ResultPair("http://", true);
   //    ResultPair testPairB = new ResultPair("3ht://", false);
   //    ResultPair testPairC = new ResultPair("www.google.com.", true);
   //    StringBuilder testBufferA = new StringBuilder();
   //    StringBuilder testBufferB = new StringBuilder();

   //    assertTrue(testPairA.valid);
   //    assertFalse(testPairB.valid);

   //    testBufferA.append(testPairA.item);
   //    testBufferA.append(testPairC.item);
   //    testBufferB.append(testPairB.item);
   //    testBufferB.append(testPairC.item);

   //    assertTrue(urlValidator.isValid(testBufferA));
   //    assertFalse(urlValidator.isValid(testBufferB));
   //    System.out.print("Test resultPairTestValidator() - Complete");
   // }

   // // Construct a UrlValidator with valid schemes of "http", and "https".
   // public static void UrlValidatorBasicTestValidator() {
   //    String[] schemes = { "http", "https" };
   //    UrlValidator urlValidator = new UrlValidator(schemes);
   ...
   //    }
   //    // prints "url is valid"
   //    System.out.println("Test UrlValidatorBasicTestValidator - Complete");
   // }

   // public static void testValidator200StatusCodes() {
   //    System.out.print("Test - 200 Status Codes");
   //    // testValidator202();
   //    // testValidator204();
   //    // testValidator218();
   //    // testValidator235();
   ...
   // ResultPair[] testUrlAuthority = { new ResultPair("www.google.com", true), new ResultPair("www.google.com.", true),
   //       new ResultPair("go.com", true), new ResultPair("go.au", true), new ResultPair("0.0.0.0", true),
   ...
   //       new ResultPair("1.2.3", false), new ResultPair(".1.2.3.4", false), new ResultPair("go.a", false),
   //       new ResultPair("go.a1a", false), new ResultPair("go.cc", true), new ResultPair("go.1aa", false),
   //       new ResultPair("aaa.", false), new ResultPair(".aaa", false), new ResultPair("aaa", false),
   ...
   //       new ResultPair(":65636", false), new ResultPair(":999999999999999999", false), new ResultPair(":65a", false) };
   ...
   //       new ResultPair("httpd", false), new ResultPair("gopher", true), new ResultPair("g0-to+.", true),
   //       new ResultPair("not_valid", false), // underscore not allowed
   //       new ResultPair("HtTp", true), new ResultPair("telnet", false) };

   public static void main(String[] args) {
      // testIsValid();
      // resultPairTestValidator();
      // UrlValidatorBasicTestValidator();
      // testValidator200StatusCodes();
